<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Managemaster.Master" AutoEventWireup="true"
    CodeBehind="edituser.aspx.cs" Inherits="CMS.Manage.edituser" %>
        ...
        <div class="content">
            <fieldset>
                ...
                <div class="rowelement">
                    ...
                    <div class="span6 right">
                        <asp:TextBox ID="txtMob" runat="server" MaxLength="40" CssClass="ltr req" Width="200"></asp:TextBox>

                        <asp:CheckBox ID="chbMob" runat="server" Text=" تایید شده" />
                    </div>
                    <div class="clear">
                    </div>
                </div>
                ...
                <div class="rowelement">
                    ...
                    <div class="span6 right">
                        <asp:TextBox ID="txtMail" runat="server" MaxLength="100" CssClass=" ltr" Width="200"></asp:TextBox>
                    </div>
                    <div class="clear">
                    </div>
                </div>
                ...
                <div class="rowelement" runat="server" visible="false">
                    ...
                    <div class="span6 right">
                        <asp:CheckBox ID="chbBanned" runat="server" Text=" مسدود" />
                        <br />
                        علت:
                        <asp:TextBox ID="txtBannedMassage" runat="server"></asp:TextBox>
                    </div>
                    <div class="clear">
                    </div>
                </div>
                ...
                <div class="rowelement">
                    ...
                    <div class="span6 right">
                        <asp:TextBox ID="txtbname" Width="200" MaxLength="100" runat="server" CssClass=""></asp:TextBox><br />
                    </div>
                    <div class="clear">
                    </div>
                    ...
                    <div class="span6 right">
                        <asp:TextBox ID="txtbhesab" Width="200" runat="server" MaxLength="50" CssClass="ltr ltrsp"></asp:TextBox><br />
                    </div>
                    <div class="clear">
                    </div>
                    ...
                    <div class="span6 right">
                        <asp:TextBox ID="txtbshomare" Width="200" MaxLength="50" runat="server" CssClass="ltr  ltrsp"></asp:TextBox><br />
                    </div>
                    <div class="clear">
                    </div>
                    ...
                    <div class="span6 right">
                        <asp:TextBox ID="txtbsheba" Width="200" MaxLength="50" runat="server" CssClass="ltr  sheba ltrsp"></asp:TextBox>
                    </div>
                    <div class="clear">
                    </div>
                    ...
                    <div class="span6 right">
                        <asp:TextBox ID="txtbsaheb" Width="200" MaxLength="100" runat="server" CssClass=""></asp:TextBox><br />
                    </div>
                    <div class="clear">
                    </div>
                    ...
                    <div class="span6 right">
                                                ...
                                                <asp:TextBox ID="txtMeli" Width="200" MaxLength="100" runat="server" CssClass=""></asp:TextBox><br />
