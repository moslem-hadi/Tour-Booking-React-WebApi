<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Managemaster.Master" AutoEventWireup="true" CodeBehind="readmail.aspx.cs" Inherits="CMS.Manage.readmail" %>

<%@ Register Assembly="HRaz.MessageBox" Namespace="HRaz.MessageBox" TagPrefix="cc1" %>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server"> 
    <style>.tlt{width:90px}</style>

<div class="box half  content"  style="width:420px">
<div class="header">
<h4> <%= pmtitle %></h4>
</div> 
      ...
      <cc1:messagebox id="MessageBox1" runat="server" messagetype="Submit" Message="پیام شما ارسال شد."
                ...
                <div class="rowelement" id="txt" runat="server">
                    ...
                    <div class="span6 right">
                        ...
                        <div style=" padding-right:261px"><asp:Button ID="Button2" runat="server" 
