<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/Managemaster.Master" AutoEventWireup="true" CodeBehind="editproduct.aspx.cs" Inherits="CMS.Manage.editproduct" ValidateRequest="false" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="cont tabs padding-reset ui-tabs ui-widget ui-widget-content ui-corner-all">
        <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
            <li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active"><a href="editproduct.aspx?id=<%=Request.QueryString["id"] %>">ویرایش محصول</a></li>
        ...
        <div id="tabs-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom" style="padding: 10px 0">
            ...
            <fieldset>
                ...
                <div class="cute">
                    <ce:editor runat="server" id="ceText" themetype="Office2003" editorwysiwygmodecss="~/adminpanel/css/WysiwygCss.css" height="400px" width="845px"
                        configurationpath="~/CuteSoft_Client/CuteEditor/Configuration/AutoConfigure/miniFull.config"></ce:editor>
                </div>
